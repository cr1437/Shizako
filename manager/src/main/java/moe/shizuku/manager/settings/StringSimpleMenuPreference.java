...
/**
 * a {@link rikka.preference.SimpleMenuPreference} which use string values array as entryValues.
 *
 * @author Haruue Icymoon haruue@caoyue.com.cn
 */

@SuppressLint("RestrictedApi")
public class StringSimpleMenuPreference extends Preference {
    ...
    @SuppressLint("RestrictedApi")
    public StringSimpleMenuPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mEntryValues = getStringArray(a, R.styleable.ListPreference_entryValues,
    ...
    public StringSimpleMenuPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, R.style.Preference_SimpleMenuPreference);
    }

    public StringSimpleMenuPreference(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.simpleMenuPreferenceStyle);
    }

    public StringSimpleMenuPreference(Context context) {
        this(context, null);
    }

    @SuppressLint("RestrictedApi")
    private static String[] getStringArray(TypedArray a, @StyleableRes int index,
     ...
     * {@link #setEntryValues(String[])}.
     *
     * @param entries The entries.
     * @see #setEntryValues(String[])
     */
    ...
    public void setValue(String value) {
        ...
        final boolean changed = !Objects.equals(mValue, value);
    ...
    public int findIndexOfValue(String value) {
        if (mEntryValues != null) {
            for (int i = mEntryValues.length - 1; i >= 0; i--) {
                String entryValue = mEntryValues[i];
